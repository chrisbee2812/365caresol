      ...
      <div className="bg-muted/50 border-b">
        <div className="container mx-auto flex h-10 items-center justify-end px-4 text-sm">
            <div className="hidden md:flex items-center gap-6 text-muted-foreground">
                ...
                <a href="mailto:enquiries@365caresolutions.co.uk" className="flex items-center gap-2 hover:text-primary transition-colors">
                    <Mail className="h-4 w-4" />
                    <span>enquiries@365caresolutions.co.uk</span>
                </a>
            </div>
